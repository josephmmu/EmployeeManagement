...
public class MainMenu {
    ...
    public static void main (String [] args) {
        ...
        try {
            ...
            Scanner fileWrite = new Scanner(employeeFile);

            FileWriter employees = new FileWriter ("Employee List.txt");
    ...
    public static String intro(File emp) {
        ...
        System.out.println("Hello and Welcome to the Employee Database");
    ...
    public static int employeeFind(File employees, String id) {
        ...
        try {
            Scanner empList = new Scanner(employees);
